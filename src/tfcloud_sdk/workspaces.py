...
#Post Requests
    ...
    def safe_delete_workspace(self, workspace_id=None, workspace_name=None):
        if workspace_id is not None:
            url = f"{self.base_url}workspaces/{workspace_id}/actions/safe-delete"
        elif workspace_name is not None:
            url = f"{self.base_url}organizations/{self.organisation}/workspaces/{workspace_name}/actions/safe-delete"
        else:
            print("Either a Workspace ID or Workspace Name must be provided")
            return None
        return self.tf_session.post(url=url)
    ...
    def force_unlock_workspace(self, workspace_id):
        url = f"{self.base_url}workspaces/{workspace_id}/actions/force-unlock"
        return self.tf_session.post(url=url)
...
#Patch Requests
    ...
    def assign_ssh_key(self, workspace_id, key_id):
        ...
        return self.tf_session.patch(url=url, data=payload)

    def unassign_ssh_key(self, workspace_id):
        return self.assign_ssh_key(workspace_id=workspace_id, key_id="null")
...
#Delete Requests
    ...
    def force_delete_workspace(self, workspace_id=None, workspace_name=None):
        if workspace_id is not None:
            ...
            print("Either a Workspace ID or Workspace Name must be provided")
            return None
        return self.tf_session.delete(url=url)
    ...
    def delete_remote_state_consumers(self, workspace_id, remote_consumer):
        ...
        url = f"{self.base_url}/workspaces/{workspace_id}/relationships/remote-state-consumers"
        return self.tf_session.delete(url=url, data=payload)
